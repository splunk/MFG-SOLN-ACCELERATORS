...
item2_qty_dicrepency = random.randint(5, 150)
...
total_weight = item1_qty * 15 + item2_qty_dicrepency * 20
...
PO1|2|{item2_qty_dicrepency}|EA|{item2_price}|PE|BP|{product2}|BO~  // Accepted: Full Quantity Available
SE|8|0002~
GE|1|2~
IEA|1|000000002~
...
HL|3|1|O~
LIN||BP|{product2}~
SN1||{item2_qty_dicrepency}|EA~  // Full Quantity Shipped for {product2}
SE|12|0003~
GE|1|3~
IEA|1|000000003~
...
IT1|2|{item2_qty_dicrepency}|EA|{item2_price}||BP|{product2}~
...
PO1|2|{item2_qty_dicrepency}|EA|{item2_price}|BP|{product2}~
SE|9|0007~
GE|1|7~
IEA|1*000000007~
...
LX|2~
W01|{item2_qty_dicrepency}|EA|BP|{product2}~
SE|10|0008~
GE|1|8~
IEA|1|000000008~
...
W12|{item2_qty_dicrepency}|EA|BP|{product2}~
SE|9|0009~
GE|1|9~
IEA|1|000000009~
...
LIN||BP|{product2}~
QTY|{item2_qty_dicrepency}|{item2_qty_inv}~
...
RCD|RE|{item2_qty_dicrepency}|EA|BP|{product2}~  // Received 40 of 50 ordered, reporting shortage
...
def generate_edi_transactions():
    ...
    event, base_date_new = generate_edi_810(buyer, seller, po_number, product1, product2, base_date_new)
    print(event,"\n\n")
    #print("DESC|EDI_810_Invoice\n\n")

    event, base_date_new = generate_edi_214(buyer, seller, carrier, po_number, shipment_id, product1, product2, base_date_new )
    print(event,"\n\n")
    #print("DESC|EDI_214_Transportation_Carrier_Shipment_Status_Message\n\n")

    event, base_date_new = generate_edi_862(buyer, seller, carrier, po_number, shipment_id, product1, product2, base_date_new )
    print(event,"\n\n")
    #print("DESC|EDI_862_Shipping_Schedule\n\n")

    event, base_date_new = generate_edi_940(buyer, seller, carrier, warehouse, po_number, shipment_id, product1, product2, base_date_new)
    print(event,"\n\n")
    #print("DESC|EDI_940_Warehouse_Shipping_Order\n\n")

    event, base_date_new = generate_edi_945(buyer, seller, carrier, warehouse, po_number, shipment_id, product1, product2, base_date_new )
    print(event,"\n\n")
    #print("DESC|EDI_945_Warehouse_Shipping_Advice\n\n")

    event, base_date_new = generate_edi_947(buyer, seller, carrier, warehouse, po_number, shipment_id, product1, product2, base_date_new )
    print(event,"\n\n")
    #print("DESC|EDI_947_Warehouse_Inventory_Adjustment_Advice\n\n")
